...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-wrap h1 { font-size: 1.4rem; color: #5b8a6e; margin-top: 0.5rem; }
        h2 { font-size: 1.2rem; color: #2d2d2d; margin-bottom: 0.4rem; }
        .subtitle { font-size: 0.88rem; color: #777; margin-bottom: 1.5rem; }
        .form-group { margin-bottom: 1.1rem; }
        label { display: block; font-size: 0.88rem; font-weight: 600; color: #444; margin-bottom: 0.4rem; }
        input[type="password"] {
            width: 100%;
        ...
        .error-msg { background: #fde8e8; color: #c0392b; border-radius: 8px; padding: 0.7rem 1rem; font-size: 0.88rem; margin-bottom: 1.2rem; }
        .success-msg { background: #e8f5e9; color: #2e7d32; border-radius: 8px; padding: 0.7rem 1rem; font-size: 0.88rem; margin-bottom: 1.2rem; }
        .btn {
            width: 100%;
            padding: 0.75rem;
            background: #5b8a6e;
...
<body>
    <div class="card">
        ...
        <form method="POST" action="/dheergayu/app/Controllers/supplier_change_password_action.php">
