...
<head>
    ...
    <link rel="stylesheet" href="css/staffhome.css?v=1.0">
    <link rel="stylesheet" href="css/staffhomeTreatmentSuggestion.css?v=1.0">
</head>
<body>
    ...
    <header class="header">
        <div class="header-left">
            <nav class="navigation">
                <button class="nav-btn active">Home</button> <!-- Home active -->
